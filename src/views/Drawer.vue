...
export default {
  ...
  methods: {
    beforeEnter(el) {
      // we want the drawer div be both invisible and have 0 width
      el.style.opacity = 0
      el.style.width = '0em'
    },
    enter(el, done) {
      Velocity(
        // element to animate
        el,
        // style it should enter to
        { opacity: 1, width: '12em' },
        // How it shoud animate
        // done means we are done with this step in transition lifecycle
